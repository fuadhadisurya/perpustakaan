          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php
                include 'koneksi.php';
                    $result= mysqli_query($conn,"SELECT * FROM anggota");//untuk akses ke table
                    while($mahasiswa=mysqli_fetch_array($result))://untuk akses data dalam tabel
                    ?>
                    <tr>
                        <th><?php echo $mahasiswa["id"]?></th>
                        <td><?php echo $mahasiswa["nama"]?></td>
                        <td><?php echo $mahasiswa["nim"]?></td>
                        <td><?php echo $mahasiswa["kelas"]?></td>
                        <td><?php echo $mahasiswa["kontak"]?></td>
                        ...
                        <td><img src="<?php echo "proses/image/".$mahasiswa['nama_file'];?>"width="60px"></td>
                        <td>
                            <a class="btn btn-warning" href="edit_anggota.php?id=<?php echo $mahasiswa["id"] ?>">Edit</a>
                            <a class="btn btn-danger" onclick="return confirm('Are you want deleting data')" href="proses/hapus.php?id=<?php echo $mahasiswa["id"] ?>">Hapus</a>
                        </td>
                    </tr>
                    <?php //endwhile;
                    endwhile;
