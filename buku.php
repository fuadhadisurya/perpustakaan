      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Daftar Koleksi Buku Perpustakaan</div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                 ...
                 <tbody>
                    <?php
                      $result= mysqli_query($conn,"SELECT * FROM buku");//untuk akses ke table
                      while($buku=mysqli_fetch_array($result))://untuk akses data dalam tabel
                    ?>
                    <tr>
                      ...
                      <td><img src="<?php echo "proses/image/".$buku['nama_file'];?>" width="60px"></td>
                      <td>
                      <a class="btn btn-warning" href="edit_entry.php?id=<?php echo $buku["id"] ?>">Edit</a>
                      <a class="btn btn-danger" onclick="return confirm('Are you want deleting data?')" href="proses_buku/hapus.php?id=<?php echo $buku["id"] ?>">Hapus</a>
                      </td>
                      </tr>
                        <?php //endwhile;
                         endwhile;
