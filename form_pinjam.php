  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form action="proses_transaksi/do_pinjam.php" method="post" id="form-pinjam" enctype="multipart/form-data">
          <div class="container">
            <div class="row">
              <div class="form-group col-md-2">
                <label for="nim">NIM</label>
                <input type="text" onkeyup="anggota()" class="form-control" id="nim" name="nim" required autofocus>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="form-group col-md-2">
                ...
                <input type="text" onkeyup="buku()" class="form-control" id="id" name="id" required>
              </div>
              <div class="form-group col">
            ...
            <div class="row">
              <div class="form-group col-md-2">
                ...
                <input type="text" onkeyup="buku2()" class="form-control" id="id2" name="id2">
              </div>
              <div class="form-group col">
                <label for="judul2">Judul Buku</label>
                <input type="text" class="form-control" id="judul2" name="judul2" readonly>
              </div>
              <div class="form-group col">
                <label for="penulis2">Penulis buku</label>
                <input type="text" class="form-control" id="penulis2" name="penulis2" readonly>
              </div>
            </div>
          </div>
          <div class="container">
            <div class="row">
              <div class="form-group col-md-2">
                ...
                <input type="date" class="form-control" id="tglp" name="tglp" required>
              </div>
              <div class="form-group col-md-2">
                <label for="ba">Batas Akhir</label>
                <input type="date" class="form-control" id="ba" name="ba" required>
              </div>
            </div>
          </div>
          <div class="form-group col-md-2">
            <input type="hidden" class="form-control" value="Pinjam" name="status" id="status">
          </div>
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script type="text/javascript">
    function anggota(){
      var nim = $('#nim').val();
      $.ajax({
        url : 'proses_transaksi/do_ajax.php',
        data : 'nim='+nim,
      }).done(function(data){
        var json = data,
        obj = JSON.parse(json);
    ...
    function buku(){
      var id = $('#id').val();
      $.ajax({
        url : 'proses_transaksi/do_ajax_buku.php',
        data : 'id='+id,
      }).done(function(data){
        var json = data,
        obj = JSON.parse(json);
    ...
    function buku2(){
      ...
      $.ajax({
        ...
        var json = data,
        obj = JSON.parse(json);
        $("#judul2").val (obj.judul);
        $("#penulis2").val (obj.penulis);
      });
    }
  </script>
</body>
