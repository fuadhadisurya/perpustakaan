  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        ?>
        <form action="proses_buku/do_edit_buku.php" method="post" id="form-buku" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $buku['id'] ?>" />
            <div class="form-group col">
                <label for="judul">Judul Buku</label>
                <input type="text" name="judul" placeholder="Judul Buku" id="judul" class="form-control" value="<?php echo $buku['judul'] ?>" required autofocus>
            </div>
            <div class="container">
                <div class="row">
                    <div class="form-group col">
                        <label for="penulis">Penulis</label>
                        <input type="text" name="penulis" placeholder="Penulis" id="penulis" class="form-control" min="7" value="<?php echo $buku['penulis'] ?>" required autofocus>
                    </div>
              ...
              <div class="container">
                  <div class="row">
                    <div class="form-group col">
                        ...
                        <input type="text" name="penerbit" placeholder="Penerbit" id="penerbit" class="form-control" value="<?php echo $buku['penerbit'] ?>" required autofocus>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="thn">Tahun Terbit</label>
                        <input type="text" name="thn" placeholder="Tahun Terbit" id="thn" class="form-control" value="<?php echo $buku['tahun_terbit'] ?>" required autofocus>
                    </div>
                  </div>
              </div>
              <div class="form-group col">
                <label for="foto">Upload Foto</label><br>
                <input type="file" name="foto" placeholder="foto" id="foto" class="block" value="<?php echo $mahasiswa['foto'] ?>">
              </div>
              </div>
