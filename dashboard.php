...
<head>
  ...
  <title>Perepustakaan Admin - Dashboard</title>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Daftar Anggota</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="anggota.php">
                <span class="float-left">Klik untuk melanjutkan</span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-info o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Registrasi Calon Anggota</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="registrasi_anggota.php">
                <span class="float-left">Klik untuk melanjutkan</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Daftar Buku</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Entry Buku</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="entry.php">
                <span class="float-left">Klik untuk melanjutkan</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-dark o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Pinjam & Kembali</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="pinjam.php">
                <span class="float-left">Klik untuk melanjutkan</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-secondary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Form Pinjam</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="form_pinjam.php">
                <span class="float-left">Klik untuk melanjutkan</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
